            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <ul class="dropdown-menu">
                        <li class="header">You have nine task</li>
                        <li>
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <a href="{{url('admin/employ')}}">
                        <i class="fa fa-th"></i> <span>View Employee</span>
                        <span class="pull-right-container">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="{{url('admin/emp/create')}}"><i class="fa fa-circle-o"></i> Add Leave</a></li>
                        <li><a href="{{url('admin/emp')}}"><i class="fa fa-circle-o"></i> View Leave</a></li>
                    </ul>
                </li>
                <li class="active treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{url('admin/payroll')}}"><i class="fa fa-circle-o"></i> View Payroll</a></li>
                        <li><a href="{{url('admin/downloadpayroll')}}"><i class="fa fa-circle-o"></i> Download Payroll</a></li>
                    </
                    </ul>
                </li>
                ...
                <li>
                    <a href="employee_details/create">
